Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/wildtigon/VerifyCode-iOS.git", :tag => 'fix_apple_silicon' }
  s.requires_arc = true
  s.platform     = :ios
  s.vendored_frameworks ='Release/VerifyCode_iOS_3.2.3_apple_silicon/VerifyCode.framework'
